...
bool cariBuku(BukuNode* head, string judulDicari) {
    ...
    // 3. Loop melalui circular linked list dengan do-while
    do {
        // Cek apakah judul buku saat ini sama dengan yang dicari
    ...
    // 4. Jika seluruh list sudah ditelusuri dan tidak ditemukan
    return false;
}
...
int main() {
    ...
    // Menambahkan data buku ke dalam Circular Linked List
    ...
    // uji coba 1: Buku yang ada di dalam list
    string buku1 = "Pengantar Algoritma";
    // uji coba 2: Buku yang TIDAK ada di dalam list
